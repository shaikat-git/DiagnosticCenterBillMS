<%@ Page Title="" Language="C#" MasterPageFile="~/MainUI.Master" AutoEventWireup="true" CodeBehind="TypeWiseReportUI.aspx.cs" Inherits="DiagnosticCenterBillManagementSystemApp.UI.TypeWiseReportUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContainerCPH" runat="server">
    <div>
        ...
        <table>
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="typeWiseGridView" runat="server" AutoGenerateColumns="False" Width="100%" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical">
            ...
            <tr>
                <td colspan="2">
                    <asp:Label ID="typeWiseReportMessageLabel" runat="server" Text=""></asp:Label></td>
            </tr>
        </table>
    </div>
