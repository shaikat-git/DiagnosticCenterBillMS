<%@ Page Title="" Language="C#" MasterPageFile="~/MainUI.Master" AutoEventWireup="true" CodeBehind="TestWiseReportUI.aspx.cs" Inherits="DiagnosticCenterBillManagementSystemApp.UI.TestWiseReportUI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContainerCPH" runat="server">
    <div>
        ...
        <table>
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="testWiseGridView" runat="server" AutoGenerateColumns="False" Width="100%" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical">
            ...
            <tr>
                <td colspan="2">
                    <asp:Label ID="testWiseReportMessageLabel" runat="server" Text=""></asp:Label></td>
            </tr>
        </table>
    </div>
